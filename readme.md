...
本项目逆推了 2014-2024 年间各类互联网公司的种种恶行，并进行了分析。
...
2.  修改用户 Windows 系统的开机启动项（通过组策略和注册表实现）
...
![image](https://github.com/rinstugames/who_commits_phone_fraud/blob/main/Screenshot3.png)
...
上述公司的行为包括但不限于：推送涉诈性质的色情广告、推送黑网贷广告、推送网络赌博广告、超规格收集个人隐私信息、将个人信息打包销售给第三方、扫盘、扫内存，相较于重橙、百度、2345的做法更为柔和，但依旧无法掩盖其为电诈帮凶的事实。
